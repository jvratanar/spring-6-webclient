...
class BeerClientImplTest {
    ...
    void testUpdate() {
        ...
        this.client.listBeerDtos()
                .next()
                .doOnNext(beerDTO -> beerDTO.setBeerName(NAME))
                .flatMap(dto -> this.client.updateBeer(dto))
                .subscribe(byIdDto -> {
    ...
    void testGetBeerByBeerStyle() {
        ...
        this.client.getBeerByBeerStyle("Pale Ale")
                .subscribe(dto -> {
                    System.out.println(dto.toString());
                    atomicBoolean.set(true);
                });
    ...
    void testGetBeerById() {
        ...
        this.client.listBeerDtos()
                .flatMap(dto -> this.client.getBeerById(dto.getId()))
                .subscribe(byIdDto -> {
    ...
    void testGetBeerDto() {
        ...
        this.client.listBeerDtos().subscribe(dto -> {
    ...
    void testGetBeerJson() {
        ...
        this.client.listBeerJsonNode().subscribe(jsonNode -> {
